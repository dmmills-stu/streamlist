...
const MovieItem: React.FC<MovieItemProps> = ({ title, watched, onWatched, onEdit, onDelete }) => {
  ...
  return (
    <li className="movie-item">
      ...
      <span className="movie-title" style={{ textDecoration: watched ? "line-through" : "none" }}>
        {title}
      </span>
